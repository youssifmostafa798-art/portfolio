...
class HungryyCaseStudyPage extends StatefulWidget {
  const HungryyCaseStudyPage({super.key});

  @override
  State<HungryyCaseStudyPage> createState() => _HungryyCaseStudyPageState();
}

class _HungryyCaseStudyPageState extends State<HungryyCaseStudyPage> {
...
class _ProjectContentBody extends StatelessWidget {
  ...
  List<Widget Function(BuildContext)> get _sections => [
        ...
        // 2. Project Overview
        (ctx) => _buildSection(HungryyTextSection(
              title: 'Project Overview',
              subtitle:
                  'What Hungryy is, the problem it solves, and why it matters.',
        ...
        (ctx) => const _DividerWidget(),
        // 6. Core Features
        (ctx) => _buildSection(HungryyCardGridSection(
              title: 'Core Features',
              subtitle:
        ...
        (ctx) => _buildSection(HungryyImagePlaceholdersSection(
              title: 'Screenshots',
              subtitle:
        ...
        // 9. Folder Structure
        (ctx) =>
            _buildSection(HungryyFolderStructureSection(data: data)),
        (ctx) => const _DividerWidget(),
        // 10. State Management
        (ctx) => _buildSection(HungryyTextSection(
              title: 'State Management',
              subtitle:
                  'Provider-based reactive state using ChangeNotifier.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Abstracting API calls from the UI layer.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Token persistence with a minimal wrapper.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Real-time price calculations with tax and delivery fees.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'From order summary to animated success confirmation.',
        ...
        (ctx) => _buildSection(HungryyCardGridSection(
              ...
              subtitle:
                  'A library of widgets shared across the application.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              title: 'Validation',
              subtitle:
                  'Form validation with regex and minimum length requirements.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Shimmer placeholder effects using the skeletonizer package.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Comprehensive error handling from network to screen level.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Techniques for efficient, responsive, and smooth operation.',
        ...
        (ctx) => _buildSection(HungryyTextSection(
              ...
              subtitle:
                  'Why each technology and pattern was chosen.',
              body: data.technicalDecisionsBody,
            )),
        (ctx) => const _DividerWidget(),
        // 30. Challenges
        (ctx) => _buildSection(HungryyProblemSolutionSection(
              title: 'Challenges',
              subtitle:
        ...
        (ctx) => const _DividerWidget(),
        // 32. Lessons Learned
        (ctx) => _buildSection(HungryyBulletListSection(
              title: 'Lessons Learned',
              subtitle:
                  'Key takeaways from building Hungryy.',
        ...
        (ctx) => _buildSection(HungryyBulletListSection(
              ...
              subtitle:
                  'Technical capabilities showcased through this project.',
        ...
        (ctx) => _buildSection(HungryyBulletListSection(
              ...
              subtitle:
                  'What I built and owned in this project.',
        ...
        (ctx) => _buildSection(HungryyBulletListSection(
              ...
              subtitle:
                  'Notable outcomes and technical accomplishments.',
