...
class HungryyArchitectureSection extends StatelessWidget {
  final HungryyData data;
  const HungryyArchitectureSection({super.key, required this.data});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('The layered architecture powering the application.',
              style: TextStyle(
          ...
          Column(
            children: List.generate(data.architectureLayers.length, (i) {
              final layer = data.architectureLayers[i];
              final isLast = i == data.architectureLayers.length - 1;
              return Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  _LayerCard(
                      layer: layer, index: i, isDark: isDark, isMobile: isMobile),
...
class _LayerCard extends StatelessWidget {
  final HungryyArchitectureLayer layer;
  final int index;
  final bool isDark;
  final bool isMobile;
  const _LayerCard(
  ...
  Widget build(BuildContext context) {
    final colors = [
      ...
      HungryyColors.secondary,
      HungryyColors.accent,
      HungryyColors.lightAccent,
      HungryyColors.glass,
    ];
